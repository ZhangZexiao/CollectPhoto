...
namespace TagLib.Id3v2
{
	...
	{
		Other=0x00,MasterVolume=0x01,FrontRight=0x02,FrontLeft=0x03,BackRight=0x04,BackLeft=0x05,FrontCentre=0x06,BackCentre=0x07,Subwoofer=0x08
	}
	public class RelativeVolumeFrame:
	Frame
	{
...
#region Classes
		private struct ChannelData
		{
			...
			public double PeakVolume
			{
				...
				set
				{
					PeakVolumeIndex=(ulong)(value*512.0);
				}
			}
		}
#endregion
